...
# MODIFIED: Point to the BONE-MOTION model checkpoint you downloaded
load_from = 'checkpoints/stgcn_8xb16-bone-motion-u100-80e_ntu120-xsub-keypoint-3d_20221129-3cb0e4e1.pth'
...
train_pipeline = [
    dict(type='GenSkeFeat', feats=['bm']),          # MODIFIED: Set to 'bm' for BONE-MOTION
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(project='5xSTS-Bone-Motion-Model')) # ADDED: New W&B project name
    ])

# python tools/train.py configs/skeleton/stgcn/stgcn_bone_motion_finetune_5xsts.py